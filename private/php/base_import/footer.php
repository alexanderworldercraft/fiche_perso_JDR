...
<div class="position-fixed top-0 end-0 p-3" style="z-index: 11">
    <div id="toastMessage" class="toast bg-bleu border-primary" role="alert" aria-live="assertive" aria-atomic="true">
        ...
        <div class="toast-body">
            <span id="toastBody" class="text-secondary-emphasis"></span>
        </div>
    </div>
</div>
...
<div id="btn-theme" class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
    <button class="btn btn-bd-primary py-2 dropdown-toggle d-flex align-items-center border" id="bd-theme" type="button"
